...
public:
    // Constructor
    TacticalUnit(std::string name, int org, int morale, int fuel, int ammunition, 
        ...
        int personnelEquipment, TacticalUnitType type, int range = 0)
        : Unit(name, org, morale, fuel, ammunition, supply, entrench, hardness,
